...
plt.hist(y_train, np.arange(clasNum+1.0), alpha=0.5, histtype='bar', ec='black')
...
channels, accuracyList = features.secuentialFeatureSelection(X_train, y_train, X_test, y_test, nFeatures, nFeatures, nChannels, clasNum , model = modelo)

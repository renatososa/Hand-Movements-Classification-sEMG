...
plt.ylabel("Accuracy (%)")
plt.title("Accuracy para cada característica (16 canales)")
plt.legend()
plt.show()
...
plt.ylabel("Accuracy (%)")
plt.title("Accuracy en función de la cantidad de canales (rms, wl, zc, ssc)")
plt.legend()
plt.ylim(60,100)
plt.show()
# =============================================================================
...
fig.suptitle("Distribución de 8 electrodos para la mejor accuracy (rms, wl, zc, ssc)")
plt.show()
# =============================================================================
# =============================================================================
...
plt.plot(np.array(featureAnalisisSVM[1])*100,"-o", label = 'SVM')
plt.plot(np.array(featureAnalisisGBM[1])*100,"-o", label = 'GBM')
plt.plot(np.array(featureAnalisisMLP[1])*100,"-o", label = 'MLP')

plt.grid()
plt.xlabel("Número de caracteristicas")
plt.ylabel("Accuracy (%)")
plt.title("Accuracy en función de la cantidad de caracteristicas (16 canales)")
plt.legend()
plt.ylim(60,100)
plt.show()
# =============================================================================
...
plt.xlabel("Número de caracteristicas")
plt.ylabel("Accuracy (%)")
plt.title("Accuracy en función de la cantidad de caracteristicas (8 mejores canales)")
plt.legend()
plt.ylim(80,100)
plt.show()
